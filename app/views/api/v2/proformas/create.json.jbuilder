...
json.messages do
  json.simple_message (@error.present? or @validation_errors.present?) ? I18n.t(:error_try_after_sometime) : I18n.t(:success_proforma_generated)
  json.internal_message I18n.t(:success_proforma_generated)
...
if @error.present? or @validation_errors.present?
  json.data Hash.new
	...
	json.data do
    json.partial! 'api/v2/proformas/proforma', proforma: @proforma
  end
end