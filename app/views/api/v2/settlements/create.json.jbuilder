...
json.messages do
  json.simple_message (@error.present? or @validation_errors.present?) ? I18n.t(:error_try_after_sometime) : I18n.t(:success_bill_settled)
  json.internal_message I18n.t(:success_bill_settled)
...
if @error.present? or @validation_errors.present?
  ...
  json.data do
    json.partial! 'api/v2/settlements/settlement', settlement: @settlement
  end  
end