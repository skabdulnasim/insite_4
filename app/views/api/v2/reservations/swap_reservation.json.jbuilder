...
json.messages do
  json.simple_message (@error.present? or @validation_errors.present?) ? I18n.t(:reservation_not_swap) : I18n.t(:success_reservation_swap)
  json.internal_message I18n.t(:success_reservation_swap)
