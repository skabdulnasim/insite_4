...
json.messages do
  json.simple_message (@error.present? or @validation_errors.present?) ? I18n.t(:error_try_after_sometime) : I18n.t(:success_visiting_history_generated)
  json.internal_message I18n.t(:success_visiting_history_generated)
...
if @error.present? or @validation_errors.present?
  ...
  json.data do
  	json.extract! @visiting_history, :id
  end	
end