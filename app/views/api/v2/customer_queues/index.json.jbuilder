...
json.messages do
  json.simple_message @error.present? ? I18n.t(:error_queue_customers_not_found) : I18n.t(:success_all_customer_records_found)
  json.internal_message @error.present? ? @error.message : I18n.t(:success_all_customer_records_found)
  ...
  json.data Array.new
	...
	json.data do
		...
		json.customer_queues @customer_queues do |customer_que|
			...
			json.preauth customer_que.preauth_value
