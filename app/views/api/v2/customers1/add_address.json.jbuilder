...
if @error.present?
  ...
  json.data do
    json.extract! @response[:address], :id, :customer_id, :receiver_first_name, :contact_no, :receiver_last_name, :delivery_address, :locality, :landmark, :city, :state, :pincode,:latitude, :longitude
  end  
end