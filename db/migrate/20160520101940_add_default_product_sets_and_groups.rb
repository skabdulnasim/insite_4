class AddDefaultProductSetsAndGroups < ActiveRecord::Migration
  def up
  ...
  def down
    ProductAttributeSet.destroy_all
    ProductAttributeGroup.destroy_all
    ProductAttributeKey.destroy_all
    ProductAttributeOption.destroy_all
  end
end