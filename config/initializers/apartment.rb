...
Apartment.configure do |config|
  ...
  config.excluded_models = ['Account','AccessManager', 'Permission', 'PermissionGroup','TableState','ResourceState','OrderStatus','DeliveryBoy','ReportFolder','Country','Denomination','CustomerQueueState', 'Day', 'CustomerState','MasterModel','CustomerState','CountryCurrency']
